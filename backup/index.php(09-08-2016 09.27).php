        ...
        <table class="table table-bordered">
          <thead>
            <tr>
			  ...
			  <th class="col-md-2">Keterangan</th><th class="col-md-2">Guru Piket</th><th class="col-md-2">ActionButton</th>
            </tr>
          </thead>
          <tbody>
              <?php
    ...
    //                    echo "<table><tr><th>ID</th><th>Name</th></tr>";
                        ...
                        { 
                            echo "<tr>"
                                  ...
                                  . "<td>".$row["guru"]."</td>"
                                  . "<td><button type='submit' name='update$i' class='glyphicon glyphicon-edit btn btn-primary' data-toggle='modal' data-target='#update'></button>"
                                  . "<button type='submit' name='delete$i' class='glyphicon glyphicon-trash btn btn-primary' data-toggle='modal' data-target='#delete'></button></td>"  
                                  . "</tr>";
                            $i++;
                        }
                    }

...
<div class="well container-fluid" style="margin-top:-20px; overflow-y: scroll; height:1000px;">
    <div class="row">
<!--    <div class="modal fade col-sm-3" id="insert2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title" id="myModalLabel">Tambah Absen Siswa</h4>
     </div>
...
<!--                                </datalist>
                            ...
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                <button type="submit" name="close" class="btn btn-warning" data-dismiss="modal">Close
...
<!--       <div class="form-group">
   ...
   <div class="modal-dialog">
           ...
           <input type="hidden" class="form-control" id="type" name="type">
             <div class="form-group">
				...
				<b>Tanggal :</b>
                                ...
                                <input type="text" name="tanggal" id="tanggal2" value="<?php echo indonesian_date();?>"/>
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal" onclick="showInsertError()">Submit</button>
      <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
     </div>
    </div>
   </div>

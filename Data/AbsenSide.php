 ...
 */
 $aColumns = array( 'no','induk', 'nama', 'kelas', 'tanggal', 'keterangan', 'guru', 'tahun' ); //Kolom Pada Tabel
 
 // Indexed column (used for fast and accurate table cardinality)
 $sIndexColumn = 'no';
 
 // DB table to use
 $sTable = 'absen'; // Nama Tabel
...
//  $btn = '<a href="#" onClick="showModals('.$aRow['no'].')">Edit</a> | <a href="#" onClick="deleteUser('.$aRow['no'].')">delete</a>';
  ...
  $row = array( $btn, $aRow['no'], $aRow['induk'], addslashes($aRow['nama']), $aRow['kelas'], $aRow['tanggal'], $aRow['keterangan'], $aRow['guru'], $aRow['tahun']);
  $output['aaData'][] = $row;
 }

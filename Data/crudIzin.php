...
if(getCookies() == TRUE)
{
 ...
 switch ($_POST['type']) {
  ...
  case "get":
   ...
   $SQL = mysqli_query($con, "SELECT * FROM izin WHERE no='".$_POST['no']."'");
        ...
        if ($result->num_rows > 0) 
        {
            ...
            if ($result->num_rows > 0) 
            {
                ...
                if ($result->num_rows > 0) 
                {
                    ...
                    $result = mysqli_query($con, "SELECT MAX(no) FROM izin");
                    ...
                    $tanggal_siswa = $_POST['tanggal'];
                    $keperluan_siswa = $_POST['keterangan'];
...
//    if ($result->num_rows > 0) 
    {
       $SQL = mysqli_query($con, "DELETE FROM izin WHERE no='".$_POST['no']."'");
       if($SQL){

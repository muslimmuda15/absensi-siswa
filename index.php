...
<div class="well container-fluid" style="margin-top:-20px; overflow-y: scrollz; height:1000px;">
    <div class="row">
          ...
          <tbody>
              <?php
                ...
                if($kelas==="")
                {
                    $i=1;
                //    echo "Connected successfully";
                    $sql = "SELECT * from absen order by tanggal";
    //                echo $sql;
                    $result = $conn->query($sql);
...
//      $("#removeWarning").show();
      ...
      $("#tahun").val(data.tahun).attr("disable","true");
      $("#myModals").modal("show");
//      waitingDialog.hide();   
     },
     error: function (jqXHR, exception) {

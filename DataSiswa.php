...
//     "scrollX": true,
     ...
     "bJQueryUI":false,
     "responsive": false,
     "sAjaxSource": "Data/DataSiswaSide.php", // Load Data
     "sServerMethod": "POST",
     "columnDefs": [
   ...
   <div class="row">
    <div class="col-md-12">
      ...
      <div style="text-align: center;">
        <span style="color: black; font-family: Verdana,Arial,Helvetica,Georgia; font-size: 35px;">Rekapan Absen Siswa</span>
        </div>
             ...
             <!--<div class="form-group">-->
				...
				<label for="siswa">Nama Siswa</label>
					...
					<span class="glyphicon glyphicon-search"></span>
                                        ...
                                        <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Siswa" autocomplete="off" required>
 ...
 <div class="modal fade" id="errorModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
   <div class="modal-dialog">
    ...
    <table class="table table-bordered" id="tableAll" style="display:none;">
          <thead>
            <tr>
              <th class="col-md-1">#</th><th class="col-md-1">Induk</th><th class="col-md-2">Nama</th><th class="col-md-2">Kelas</th>
            </tr>
          </thead>
          <tbody>
              <?php
                ...
                //    echo "Connected successfully";
                    $sql = "SELECT * from siswa order by no";
    //                echo $sql;

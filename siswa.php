...
//     "scrollX": true,
     ...
     "bJQueryUI":false,
     "responsive": false,
     "sAjaxSource": "Data/SiswaSide.php", // Load Data
     "sServerMethod": "POST",
     "columnDefs": [
 ...
 <div class="modal fade" id="errorModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
   <div class="modal-dialog">
    ...
    <table class="table table-bordered" id="tableAll" style="display:none;">
          <thead>
            <tr>
              <th class="col-md-1">#</th><th class="col-md-1">Induk</th><th class="col-md-2">Nama</th><th class="col-md-2">Kelas</th><th class="col-md-2">Hafalan</th>
            </tr>
          </thead>
          <tbody>
              <?php
                ...
                if($kelas==="")
                {
                    $i=1;
                //    echo "Connected successfully";
                    $sql = "SELECT * from siswa_hafalan order by no";
    //                echo $sql;
...
//      $("#removeWarning").show();
      ...
      $("#no").val(data.no);
      $("#induk").val(data.induk).attr("disabled","true");
      $("#type").val("delete");
